...
<body>
    ...
    <div id="wrap">
        ...
        <div id="mainbody">
            ...
            <div class="bottom">
            	<table>
                <thead><td>序号</td><td>价格</td>弦数</td><td><td>制造商</td><td>型号</td><td>类型</td><td>前面材料</td><td>背面材料</td></thead>
                <%
			...
			%>
                ...
                <tbody>
                <tr><td><%=g.getSerialNumber() %></td><td><%=g.getPrice() %></td><td><%=g.getSpec().getNumStrings() %></td><td><%=g.getSpec().getBuilder() %></td><td><%=g.getSpec().getModel() %></td><td><%=g.getSpec().getType() %></td><td><%=g.getSpec().getTopWood() %></td><td><%=g.getSpec().getBackWood() %></td></tr>
                </tbody>
                <%
                }
                %>
